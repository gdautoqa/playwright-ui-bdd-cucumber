...
Then(
  'I should see the "Due" column values sorted in ascending order',
  async function () {
...
When(
  'I click on the "Last Name" header in Example 2 to sort ascending',
  async function () {
...
Then(
  'I should see the "Last Name" column values sorted alphabetically',
  async function () {
    const lastNames =
      await this.sortableDataTablesPage.getLastNameColumnValues();
