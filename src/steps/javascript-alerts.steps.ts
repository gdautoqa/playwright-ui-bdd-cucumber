...
Then('I should see alert text {string} and accept it', async function (expectedText: string) {
...
Then('I should see confirm text {string} and accept it', async function (expectedText: string) {
...
Then('I should see prompt text {string} and accept it', async function (expectedText: string) {
